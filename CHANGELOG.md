...
- Overview entering Drag & Drop after touch tap release

## 1.4.0 - 2026-03-19

### Added

- Handle bar action to turn display off on centered double-tap
...
- Default scale is calculated based on output dimensions
